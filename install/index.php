...
class citfact_filter_subscribe extends CModule
{
    /**
     * @var string
     */
    public $MODULE_ID = 'citfact.filter.subscribe';
    ...
    {
        $this->MODULE_NAME = Loc::getMessage('FILTER_SUBSCRIBE_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('FILTER_SUBSCRIBE_MODULE_DESCRIPTION');
